...
Реализована подключаемая библиотека, которую использует и загадываетль и отгадываетль для создания/решения паззла. В файле tester.rs находится пример применения.
